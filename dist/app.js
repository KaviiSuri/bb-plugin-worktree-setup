...
function LogView({ content }) {
  if (!content.trim()) {
    return /* @__PURE__ */ jsx("div", { className: "rounded-md border border-dashed border-border bg-sidebar p-6 text-center font-mono text-2xs text-muted-foreground", children: "No runs recorded yet." });
  }
...
function ScriptEditor({ rpc, repoKey }) {
  const [text, setText] = useState(null);
  const [sha, setSha] = useState(null);
  const [saving, setSaving] = useState(false);
  useEffect(() => {
    let cancelled = false;
    void rpc.call("readScript", { key: repoKey }).then((r2) => {
      if (cancelled) return;
      setText(r2.missing ? "#!/usr/bin/env bash\nset -uo pipefail\n\n" : r2.content);
      setSha(r2.sha256);
    });
    return () => {
      cancelled = true;
  ...
  const save = useCallback(async () => {
    ...
    setSaving(true);
    try {
      const r2 = await rpc.call("saveScript", { key: repoKey, content: text, expectedSha256: sha });
      if (r2.outcome === "conflict") {
  ...
  if (text === null) {
    return /* @__PURE__ */ jsx("div", { className: "p-4 text-2xs text-muted-foreground", children: "Loading\u2026" });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Button, { size: "sm", onClick: () => void save(), disabled: saving, children: saving ? "Saving\u2026" : "Save" }),
      /* @__PURE__ */ jsxs("span", { className: "ml-auto font-mono text-2xs text-muted-foreground", children: [
        "~/.bb-setup/",
        repoKey,
        ".sh"
      ] })
...
function Stat({ label, value, tone }) {
  return /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border bg-sidebar px-2.5 py-2", children: [
    /* @__PURE__ */ jsx("div", { className: "text-2xs text-muted-foreground", children: label }),
    /* @__PURE__ */ jsx("div", { className: `font-mono text-2xs ${tone ?? ""}`, children: value })
  ] });
}
function ThreadPanel({ threadId }) {
  ...
  const load = useCallback(async () => {
    const r2 = await rpc.call("resolveThread", { threadId });
    setState(r2);
    if (r2.repo) {
      const l = await rpc.call("readLog", { key: r2.repo.key });
      setLog(l.content);
    }
  }, [rpc, threadId]);
  useEffect(() => {
  ...
  if (!state) return /* @__PURE__ */ jsx("div", { className: "p-4 text-2xs text-muted-foreground", children: "Loading\u2026" });
  const s = state;
  if (!s.isWorktree) {
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center px-6 py-20 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-1.5 text-xs text-muted-foreground", children: "No worktree for this thread" }),
      /* @__PURE__ */ jsx("div", { className: "max-w-sm text-2xs leading-relaxed text-muted-foreground", children: s.reason })
    ] });
  }
  const repo = s.repo;
  return /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "font-mono text-2xs text-muted-foreground", children: [
      "repo ",
      /* @__PURE__ */ jsx("b", { className: "font-medium text-foreground", children: repo.name }),
      s.branchName ? /* @__PURE__ */ jsxs(Fragment2, { children: [
        " \xB7 branch ",
        /* @__PURE__ */ jsx("b", { className: "font-medium text-foreground", children: s.branchName })
      ] }) : null
    ] }),
    repo.drifted ? /* @__PURE__ */ jsx(
      DriftBanner,
      {
        repo,
        onRepair: async () => {
    ...
    /* @__PURE__ */ jsx("div", { className: "flex gap-1 border-b border-border", children: ["log", "script"].map((t) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => setTab(t),
        className: `-mb-px border-b-2 px-2.5 py-1.5 text-2xs ${tab === t ? "border-primary text-foreground" : "border-transparent text-muted-foreground"}`,
        children: t === "log" ? "Log" : "Setup script"
      },
      t
    )) }),
    tab === "log" ? /* @__PURE__ */ jsx(LogView, { content: log }) : /* @__PURE__ */ jsx(ScriptEditor, { rpc, repoKey: repo.key })
  ] });
}
function RepoRow({ repo, rpc, reload }) {
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("span", { className: "flex-1 truncate text-2xs text-muted-foreground", children: [
            repo.projectIds.length ? `${repo.projectIds.length} project${repo.projectIds.length > 1 ? "s" : ""}` : "no bb project",
            repo.lastRun ? ` \xB7 last run ${repo.lastRun.outcome}` : " \xB7 never run"
          ] }),
          repo.drifted ? /* @__PURE__ */ jsx(Pill, { tone: "warn", children: "drift" }) : null,
          !repo.hasScript ? /* @__PURE__ */ jsx(Pill, { children: "no script" }) : null,
          repo.lastRun?.outcome === "failed" ? /* @__PURE__ */ jsx(Pill, { tone: "bad", children: "failed" }) : null,
          /* @__PURE__ */ jsx("span", { className: "text-2xs text-muted-foreground", children: open ? "\u25BE" : "\u25B8" })
        ]
      }
    ),
    open ? /* @__PURE__ */ jsxs("div", { className: "bg-sidebar px-3.5 pb-3.5 pl-8", children: [
      repo.drifted ? /* @__PURE__ */ jsx(
        DriftBanner,
        {
          repo,
      ...
      /* @__PURE__ */ jsx("dl", { className: "mb-2 space-y-1 text-2xs", children: [
        ["Source root", repo.sourceRoot ?? "\u2014 unknown \u2014"],
        ["Setup script", repo.hasScript ? repo.scriptPath : "\u2014 none \u2014"],
        ["Log", repo.logPath]
      ].map(([k, v]) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2.5 border-b border-border py-1 last:border-b-0", children: [
        /* @__PURE__ */ jsx("dt", { className: "w-28 shrink-0 text-muted-foreground", children: k }),
        /* @__PURE__ */ jsx("dd", { className: "min-w-0 flex-1 break-all font-mono", children: v })
      ] }, k)) }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            onClick: async () => {
              if (!repo.hasScript) {
                const r2 = await rpc.call("createScript", { key: repo.key, repoName: repo.name });
                if (r2.created) toast.success(`Created ${r2.detail}`);
                reload();
              }
              setView(view === "script" ? "none" : "script");
            },
            children: repo.hasScript ? "Edit script" : "Create script"
          }
        ),
        /* @__PURE__ */ jsx(
          Button,
      ...
      view === "script" ? /* @__PURE__ */ jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsx(ScriptEditor, { rpc, repoKey: repo.key }) }) : null,
      view === "log" ? /* @__PURE__ */ jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsx(LogView, { content: log ?? "" }) }) : null
    ] }) : null
  ] });
}
function BootstrapCard({ status, rpc, reload }) {
  ...
  const run = useCallback(
    async (force) => {
      setBusy(true);
      try {
        const r2 = await rpc.call("bootstrap", force ? { force: true } : {});
        setSteps(r2.steps);
        if (r2.ok) toast.success("Git hooks set up");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-4 rounded-lg border border-[var(--attention)] bg-[var(--surface-attention)] p-3.5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-2.5 text-2xs text-muted-foreground", children: [
      ...
      " hook. Until it is wired, nothing runs when bb creates a worktree."
    ] }),
    /* @__PURE__ */ jsx("ul", { className: "mb-3 space-y-0.5 text-2xs text-muted-foreground", children: problems.map((p) => /* @__PURE__ */ jsxs("li", { children: [
      "\xB7 ",
      p
    ] }, p)) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Button, { size: "sm", onClick: () => void run(false), disabled: busy, children: busy ? "Setting up\u2026" : "Set up git hooks" }),
      status.globalConflict ? /* @__PURE__ */ jsx(Button, { size: "sm", variant: "outline", onClick: () => void run(true), disabled: busy, children: "Replace existing hooksPath" }) : null
    ] }),
    status.globalConflict ? /* @__PURE__ */ jsxs("div", { className: "mt-2 text-2xs text-muted-foreground", children: [
      "Your global ",
    ...
    steps ? /* @__PURE__ */ jsx("dl", { className: "mt-3 space-y-1 border-t border-[var(--attention)] pt-2.5 text-2xs", children: steps.map((s) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("dd", { className: "min-w-0 flex-1", children: [
        s.step,
        /* @__PURE__ */ jsx("span", { className: "ml-1.5 break-all font-mono text-muted-foreground", children: s.detail })
      ] })
    ] }, s.step)) }) : null
  ] });
}
function SettingsSection() {
  ...
  const load = useCallback(async () => {
    const [repos2, status] = await Promise.all([
  ...
  useRealtime("repos-changed", () => void load());
  if (!data) return /* @__PURE__ */ jsx("div", { className: "p-4 text-2xs text-muted-foreground", children: "Loading\u2026" });
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-lg border border-border", children: [
      /* @__PURE__ */ jsxs("div", { className: "border-b border-border px-3.5 pb-2.5 pt-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-2xs text-muted-foreground", children: "One setup script per repo, identified by its source root. Runs on every new bb worktree." })
      ] }),
      repos.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-6 text-center text-2xs text-muted-foreground", children: "No repositories found." }) : repos.map((r2) => /* @__PURE__ */ jsx(RepoRow, { repo: r2, rpc, reload: () => void load() }, r2.key)),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 border-t border-border bg-sidebar px-3.5 py-2.5 text-2xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxs("span", { children: [
          "Global ",
          /* @__PURE__ */ jsx("code", { className: "font-mono", children: "core.hooksPath" })
        ] }),
        data.globalWired ? /* @__PURE__ */ jsx(Pill, { tone: "ok", children: "~/.githooks" }) : /* @__PURE__ */ jsx(Pill, { tone: "warn", children: data.globalHooksPath ?? "unset" }),
        /* @__PURE__ */ jsx("span", { className: "flex-1" }),
        drifted.length > 0 ? /* @__PURE__ */ jsxs(Fragment2, { children: [
          /* @__PURE__ */ jsxs("span", { children: [
            drifted.length,
            " repo",
            drifted.length > 1 ? "s" : "",
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              onClick: async () => {
                ...
                toast.success(`Repaired ${r2.repaired.length}`);
                void load();
              },
              children: "Repair all"
            }
          )
        ] }) : /* @__PURE__ */ jsx("span", { children: "all wired" })
      ] })
    ] })
  ] });
}
var app_default = definePluginApp((app) => {
  app.slots.threadPanelAction({
    ...
    component: ({ threadId }) => /* @__PURE__ */ jsx(ThreadPanel, { threadId })
  });
